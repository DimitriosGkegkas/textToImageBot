    ...
    onClickHandler(key) {
        return () => {
            if (this.state.selected.includes(key)) {
                const selected = this.state.selected.filter(index => key !== index)
            ...
            columnes.push(
                <div
                    ...
                    style={{
                        ...
                        ...(this.state.selected?.includes(element.id) ? open : mes)
                    }} />
            )
        });
        columnes.push(
            <div style={{
                ...
                <div
                    ...
                    style={{
                        ...
                        ...(this.state.selected?.includes(greekCountry.slice(-3)[0].id) ? open : mes)
                    }} />
                <div
                    ...
                    style={{
                        ...
                        ...(this.state.selected?.includes(greekCountry.slice(-1)[0].id) ? open : mes)
                    }} />
            </div >
        ...
        columnes.push(
            ...
            <div
                ...
                style={{
                    ...
                    ...(this.state.selected?.includes(greekCountry.slice(-2)[0].id) ? open : mes)
                }} />
